...
public class Sequence {
    ...
    private Logger logger = LoggerFactory.getLogger(Sequence.class);
    ...
    private boolean getNextBlock(String sequenceName, Step step) {
        ...
        if (value == null) {//如果没有，就初始化
            try {
                ...
                logger.error("newPersistenceValue error!");
    ...
    private int saveValue(long value, String sequenceName) {
        ...
        try {
            ...
            logger.error("newPersistenceValue error!", e);
    ...
    private Long getPersistenceValue(String sequenceName) {
        ...
        try {
            ...
            logger.error("getPersistenceValue error!", e);
